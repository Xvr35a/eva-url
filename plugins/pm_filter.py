...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://graph.org/file/1bd20d717432420f1b061.mp4')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🔸JOIN MY GROUP🔸', url='https://t.me/scene_pack')
        ], [
            InlineKeyboardButton('JOIN CHANNEL', url='https://t.me/clips_for_editing')
        ], [
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"Requested material name: <code>{search}</code>\n\n\n If any doubt about downloading click how to download ! 👇🏻"
